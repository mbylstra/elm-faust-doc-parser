...
parseWord = createParseTokenKeepFunction Word
parseWhitespace = createParseTokenKeepFunction Whitespace
parseNewline = createParseTokenKeepFunction Newline
parseOpeningBracket = createParseTokenIgnoreFunction OpeningBracket
parseClosingBracket = createParseTokenIgnoreFunction ClosingBracket
parseEqualsSign = createParseTokenIgnoreFunction EqualsSign
parseComma = createParseTokenIgnoreFunction Comma
parseSemicolon = createParseTokenKeepFunction Semicolon
parseStartComment = createParseTokenIgnoreFunction StartComment
